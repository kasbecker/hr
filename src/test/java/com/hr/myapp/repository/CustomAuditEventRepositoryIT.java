package com.hr.myapp.repository;

import com.hr.myapp.HrApp;
import com.hr.myapp.config.Constants;
import com.hr.myapp.config.audit.AuditEventConverter;
import com.hr.myapp.domain.PersistentAuditEvent;
...
import static com.hr.myapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
